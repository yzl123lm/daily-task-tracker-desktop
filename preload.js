...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  wbProjectDelete: (payload) => ipcRenderer.invoke("wb-project-delete", payload || {}),
  ...
  wbProjectRepoProfile: (payload) => ipcRenderer.invoke("wb-project-repo-profile", payload || {}),
  wbProjectBootstrapEnv: (payload) => ipcRenderer.invoke("wb-project-bootstrap-env", payload || {}),
  ...
  wbProjectCodeSearch: (payload) => ipcRenderer.invoke("wb-project-code-search", payload || {}),
  wbProjectDiffPreview: (payload) => ipcRenderer.invoke("wb-project-diff-preview", payload || {}),
  wbProjectRunTest: (payload) => ipcRenderer.invoke("wb-project-run-test", payload || {}),
  wbProjectToolOpsList: (payload) => ipcRenderer.invoke("wb-project-tool-ops-list", payload || {}),
  wbProjectTestCommands: () => ipcRenderer.invoke("wb-project-test-commands"),
  wbProjectApplyPatch: (payload) => ipcRenderer.invoke("wb-project-apply-patch", payload || {}),
  wbProjectRunTestFix: (payload) => ipcRenderer.invoke("wb-project-run-test-fix", payload || {}),
  wbProjectGitStatus: (payload) => ipcRenderer.invoke("wb-project-git-status", payload || {}),
  wbProjectGitCommit: (payload) => ipcRenderer.invoke("wb-project-git-commit", payload || {}),
  wbProjectBackupsList: (payload) => ipcRenderer.invoke("wb-project-backups-list", payload || {}),
  wbProjectBackupRestore: (payload) => ipcRenderer.invoke("wb-project-backup-restore", payload || {}),
  wbProjectShellPresets: () => ipcRenderer.invoke("wb-project-shell-presets"),
  wbProjectRunShell: (payload) => ipcRenderer.invoke("wb-project-run-shell", payload || {}),
  ...
  wbChatArchive: (payload) => ipcRenderer.invoke("wb-chat-archive", payload || {}),
  wbChatDelete: (payload) => ipcRenderer.invoke("wb-chat-delete", payload || {}),
  ...
  wbChatMaybeSummarize: (payload) => ipcRenderer.invoke("wb-chat-maybe-summarize", payload || {}),
